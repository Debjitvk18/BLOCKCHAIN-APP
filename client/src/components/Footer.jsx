...
const Footer=()=> {
  return (
    <div className='w-fulll flex md:justify-center justify-between items-center flex-col p-4 gradient-bg-footer '>
      ...
      <div className='flex justify-center items-center flex-col mt-5'>
        ...
        <p className='text-white text-sm text-center'>info@devkrypto.com</p>
